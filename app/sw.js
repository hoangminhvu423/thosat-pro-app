...
'use strict';
const TEN_CACHE = 'thosat-pro-v9';
const VO_APP = [
  './', 'index.html', 'engine.js', 'dexe.js', 'catalogue.js', 'phieu-anh.js',
  'minh-hoa.js', 'vat-tu.js', 'manifest.webmanifest', 'icon-192.png', 'icon-512.png',
  '../catalogue/mau/danh-sach.json',
  '../catalogue/mau/LC-01.json', '../catalogue/mau/LC-02.json', '../catalogue/mau/LC-03.json', '../catalogue/mau/LC-04.json', '../catalogue/mau/CT-01.json', '../catalogue/mau/CT-02.json', '../catalogue/mau/CT-03.json',
  '../catalogue/mau/MT-01.json', '../catalogue/mau/MT-02.json',
  '../catalogue/mau/C-01.json', '../catalogue/mau/CG-01.json',
