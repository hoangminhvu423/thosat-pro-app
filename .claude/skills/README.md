> **TÁCH KHO 25/07/2026:** repo này chỉ còn skill của **ThợSắt Pro**
> (`catalogue-audit`, `them-mau`, `phat-hanh`, `dong-bo-skills`).
> Skill của hệ giao dịch (`ea-code-audit`, `guardian-rules`) đã chuyển sang repo
> **private `hoangminhvu423/qtq-rbea`** — xem README ở đó.

# Skills dùng chung — LUẬT ĐỒNG BỘ (chi tiết: hq/CLAUDE.md)

- **NGUỒN CHUẨN DUY NHẤT**: thư mục này (`.claude/skills/`), nhánh `main`,
