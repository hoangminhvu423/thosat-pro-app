---
name: dong-bo-skills
description: Đồng bộ skill dùng chung theo LUẬT ĐỒNG BỘ — kéo nguồn chuẩn GitHub (thosat-pro-app @ main) về cache máy ~/.claude/skills, rồi backup zip MacBook + Google Drive. Dùng sau khi sửa/thêm skill trong repo, hoặc khi dựng môi trường/cửa sổ mới.
---
...
1. **Kéo nguồn chuẩn**: `git pull --ff-only` clone tại `~/Downloads/thosat-pro-app`
   (tự clone nhánh `main` nếu máy chưa có).
